...
The idea came straight out of my PhD work on how people navigate real-world environments. Its sibling project, [ParkAndSave](https://github.com/eyavuz21/ParkAndSave), extends the same "optimise the errand" idea with an LLM agent and generative UI.
